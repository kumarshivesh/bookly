...
from .schemas import UserCreateModel, UserLoginModel, UserBooksModel, EmailModel, PasswordResetConfirmModel, PasswordResetRequestModel
...
async def password_reset_request(email_data: PasswordResetRequestModel):
    ...
    #message = create_message(recipients=[email], subject="Reset You Password", body=html_message)
